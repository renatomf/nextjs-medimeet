...
export default function Home() {
  return (
    <div className="bg-background">
      ...
      <section className="relative overflow-hidden py-32">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative h-[500px] lg:h-[580px] rounded-xl overflow-hidden">
              <Image
                src="/banner2.png"
                ...
                >
                  <CardContent className="pt-2">
                    <div className="flex items-center mb-4">
                      ...
                      <div>
                        <h4 className="font-semibold text-white">{testmonial.name}</h4>
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          <Card className="bg-gradient-to-r from-emerald-900/30 to-emerald-900/20 border-emerald-800/20">
            <CardContent className="p-8 md:p-12 lg:p-16 relative overflow-hidden">
              <div>
                <h2 className="text-3xl md:text-4xl font-bold text-white mb-6">
                  Ready to take control of oyour healthcare?
                </h2>
